...
?>
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                    <a class="thumbnail" href="display.php?file=<?php echo $dir."/".$ind_file;?>"><img class="img-responsive" src="<?php echo $thumbpath?>" width="400" height="300" alt=""></a><center><?PHP echo $thumb;?>        
            </div>
<?php
}}}
?>
